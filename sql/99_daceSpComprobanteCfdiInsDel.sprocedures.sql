...
AS
	...
	INSERT INTO dace.ComprobanteCFDI (UUID,TIPOCOMPROBANTE,FOLIO,FECHA,TOTAL,MONEDA,METODOPAGO,EMISOR_RFC,RESUMENCFDI,NOMBREARCHIVO,CARPETAARCHIVO, VALIDADO)
							SELECT @UUID,@TIPOCOMPROBANTE,@FOLIO,@FECHA,@TOTAL,@MONEDA,@METODOPAGO,@EMISOR_RFC,@RESUMENCFDI,@NOMBREARCHIVO,@CARPETAARCHIVO, @VALIDADO
